...
export default function GraphMenu(): React.JSX.Element {
    ...
    return (
        <div className="mt-5 bg-[#FAFBFF] rounded-md w-full h-[80vh] py-6">
            <div className="flex justify-between px-6 items-center">
                ...
                <div className="flex py-1 h-[6vh] px-3 items-center mr-2 justify-evenly bg-[#47AAC9] w-[23vw] border border-gray-200 shadow-sm rounded-md">
                    <div className="">
                        <img src={target}></img>
                    </div>
                    <div className="">
                    ...
                    <div>
                        <label className="text-white font-medium text-[1.32rem]">
