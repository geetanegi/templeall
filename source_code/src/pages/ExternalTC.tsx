    ...
    <body className="content-container text-white">
      <div className="container mx-auto p-6" style={{ width: "976px" }}>
        ...
        <div>
          ...
          <p className="font-nunito mt-2 text-lg md:text-sm  font-normal">You agree not to:</p>
          <ul className="list-disc ml-5">
            <li className="font-nunito ml-5 mt-2 text-lg md:text-sm  font-normal">
        ...
        <div>
          ...
          <p className="font-nunito mt-2 text-lg md:text-sm  font-normal">In the event of any claim or legal action arising from your use of the Services, you agree to
        ...
        <div>
          ...
          <p className="font-nunito mt-2 text-lg md:text-sm  font-normal">Some jurisdictions do not allow the exclusion or limitation of liability for consequential or
        ...
        <div>
          ...
          <p className="font-nunito mt-2 text-lg md:text-sm  font-normal">You acknowledge and agree that by entering into this Agreement, you are waiving your right to a
        ...
        <div>
          ...
          <p className="font-nunito mt-2 text-lg md:text-sm  font-normal">Changes to these Terms will take effect immediately upon posting in the Mobile Application or
        ...
        <div>
          ...
          <p className="font-nunito mt-2 text-lg md:text-sm  font-normal">These Terms, along with the Privacy Policy and any other legal notices or agreements published
        ...
        <div>
          ...
          <p className="font-nunito mt-2 text-lg md:text-sm  font-normal">If you have any questions, concerns, or requests regarding these Terms or your use of the
            AceCam Mobile Application and Services, please contact us at:</p>
          <p className="font-nunito mt-3 text-lg md:text-sm  font-normal">
