            ...
            >
                {({
                    ...
                    >
                        ...
                        >
                            <div className='flex w-[90%] md:w-[430px] gap-4'>
                                <div className='w-1/2'>
                                    <input
                                        type="text"
                                        name="firstName"
                                        ...
                                        max={100}
                                        disabled
                                        className="mx-5 w-full  rounded-lg border border-gray-200 bg-[#E6E6E6] text-[#7B7887] cursor-not-allowed px-2 py-3 "
                                    />
                            ...
                            <div className='mb-5'>
                                <input
                                    ...
                                    name="dateOfBirth"
                                    placeholder="DOB"
                                    value={values.dateOfBirth && moment(values?.dateOfBirth).format('MM/DD/YYYY')}
                                    onChange={handleChange}
                                    onBlur={handleBlur}
                                    max={maxDate}
                                    disabled
                                    className="mx-5 w-[90%] rounded-lg border bg-[#E6E6E6] text-[#7B7887] cursor-not-allowed border-gray-200  px-2 py-3 text-gray-500 md:w-[430px]"
                                />
                            </div>
                            <div className='flex w-[90%] md:w-[430px] gap-4 mb-5'>
                                <div className='w-1/2'>
                                    <input
                                        type="text"
                                        name="location"
                            ...
                            <div>
                                <div className="mb-4 w-[100%] lg:w-auto flex gap-4">
                                    <input
                                        name="countryCode"
                            ...
                            <div>
                                <input
                                    ...
                                    onBlur={handleBlur}
                                    disabled
                                    className="mx-5 w-[90%] bg-[#E6E6E6] text-[#7B7887] cursor-not-allowed  rounded-lg border border-gray-200 px-2 py-3 text-gray-500 md:w-[430px]"
                                />
                                <div className="mb-5 ml-6">
                                    {touched.email &&
                                        errors.email &&
                                ...
                                <div className="mb-5 ml-6">
                                    {touched.alternateEmail &&
                                        ...
                                        typeof errors.alternateEmail === "string" && (
                                            <span className="text-red-600">{errors.alternateEmail}</span>
                                        )}
                                </div>
                            </div>
                            <div className='mb-5'>
                            ...
                            <div className=" flex flex-col">
                                <div
                                    className={`mx-5 w-[90%] rounded-lg border border-gray-200 bg-[#F5F6F7] px-2 py-3 text-gray-500 md:w-[430px] ${cardTouched && cardError
                                        ? "border-red-500"
                                        : "border-gray-300"
                                        }`}
                                >
