    ...
    <PageLoader isActive={loader}>
      <div className="bg-backgroundDark">
        ...
        >
          {/* <AceCamUI /> */}
          <div
            className={`align-center flex h-screen w-full flex-col bg-backgroundDark  overflow-y-auto`}
          >
            <img src={aceCampLogo} alt="" className="w-[220px] mx-auto" />
            ...
            {location.pathname === ROUTES.SIGNUP && (
              <div className="mx-auto my-auto flex h-max-content w-full flex-col items-center justify-center px-5 md:w-[280px]"
              >
                {location.pathname === ROUTES.SIGNUP && (
                  // <StripeIntegration>
                  <Register />
