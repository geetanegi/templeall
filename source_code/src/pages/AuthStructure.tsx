        ...
        >
          ...
          >
            {location.pathname === ROUTES.LOGIN && (
              <div className="mx-auto flex w-full flex-col items-center justify-center md:w-[260px]">
                {location.pathname === ROUTES.LOGIN && <Login />}
              </div>
            )}
            {location.pathname === ROUTES.FORGET_PASSWORD && (
              <div className="mx-auto flex w-full flex-col items-center justify-center py-12 md:w-[260px]">
                {location.pathname === ROUTES.FORGET_PASSWORD && (
                  <ForgetPassword />
                )}
              </div>
            ...
            {location.pathname === ROUTES.SIGNUP && (
              <div className="mx-auto my-auto flex h-max-content w-full flex-col items-center justify-center py-4 md:w-[260px]">
                {location.pathname === ROUTES.SIGNUP && (
                  // <StripeIntegration>
                  <Register />
                  // </StripeIntegration>
