...
import InterventionPageMastered from './InterventionPageMastered';
...
describe('InterventionPageDiscontinued', () => {
    const ComponentWithProvider = useProviderMock(<InterventionPageMastered />);
    beforeEach(() => {
    ...
    test('should show InterventionPageMastered page', async () => {
        const { findByTestId } = render(ComponentWithProvider);
        const pageEl = await findByTestId('intervention-mastered-page');
