...
const ImageComponent: React.FC<ImageComponentProps> = ({
  ...
  return (
    <div className="left- relative top-[-24px] flex h-[432px] w-[350px] flex-col">
      <button
      ...
      <div className="border-gray relative left-[40px] top-[-68px] mx-auto h-[432px] w-[350px] border bg-gray-500 p-2 lg:border-0 lg:lg:bg-transparent">
        <div
          className="ml-auto"
