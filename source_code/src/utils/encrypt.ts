...
export const encryptData = async (plainText: string, secretKey: string): Promise<string | null> => {
  try {
...
//     const iv = combinedData.getBytes(12);
//     const ciphertext = combinedData.getBytes(combinedData.length() - 16);
//     const tag = combinedData.getBytes(16);
...
//     const decryptedPlainText = decipher.output.toString('utf8');
